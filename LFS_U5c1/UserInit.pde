...
void userInit()  // called at startup and typically by UserReset tab's userControllerResetAndRun method
{
  ...
  lfs.setFirstNameLastNameRobotName("PolyU","IC","U5c");   // change to your name and robot
  lfs.defineLapCourse(1,"U5c.png",7,12,180);
  ...
  */    
  ...
  if (genIcon)
  {
    String genInitials = "U5c";               // replace with your initials (2 or 3 char) and colors below... 
